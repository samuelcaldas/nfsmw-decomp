export const meta = {
  name: 'nfsmw-parallel-decomp-batch10',
  description: 'Batch 10 decompilation: UpdatePursuits, CalculateRegionInfo, FindFaceInCInst, CreateStreamingPack',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: UpdatePursuits (zAI) & CalculateRegionInfo (zTrack)' },
    { title: 'Decomp-2', detail: 'Pair 2: FindFaceInCInst (zWorld2) & CreateStreamingPack (zEcstasy)' },
...
log('Starting Batch 10: UpdatePursuits, CalculateRegionInfo, FindFaceInCInst, CreateStreamingPack')
