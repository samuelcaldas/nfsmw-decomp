export const meta = {
  name: 'nfsmw-parallel-decomp-batch12',
  description: 'Batch 12 decompilation: InitAtSegment, RenderVisibleSectionBoundary, InternalLoadStreamingEntry, epInitViews',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: InitAtSegment (zWorld2) & RenderVisibleSectionBoundary (zTrack)' },
    { title: 'Decomp-2', detail: 'Pair 2: InternalLoadStreamingEntry (zEcstasy) & epInitViews (zEcstasy)' },
...
const CANDIDATES_PAIR2 = [
  ...
  {
    demangled: 'epInitViews',
    symbol: 'epInitViews__Fv',
    unit: 'main/Speed/Indep/SourceLists/zEcstasy',
    size: 516,
    match: 84.27,
...
log('Starting Batch 12: InitAtSegment, RenderVisibleSectionBoundary, InternalLoadStreamingEntry, epInitViews')
