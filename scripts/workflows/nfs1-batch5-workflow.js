export const meta = {
  ...
  description: 'Batch 5 parallel decompilation: WRoadNav::InitAtSegment, TrackStreamer::DetermineStreamingSections, InternalLoadingHeaderPhase2Callback, AIPursuit::AssignClosestOffsets',
  phases: [
...
log('Starting Batch 5 parallel decomp for ' + CANDIDATES.length + ' functions across zWorld2, zTrack, zEcstasy, zAI')
...
log('Decomp phase finished: ' + succeeded.length + ' succeeded, ' + failed.length + ' failed')
