export const meta = {
  ...
  description: 'Batch 6 decompilation: FindFaceInCInst, CalculateRegionInfo, UpdatePursuits, AssignClosestOffsets',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: FindFaceInCInst (zWorld2) & CalculateRegionInfo (zTrack)' },
...
log('Starting Batch 6: FindFaceInCInst, CalculateRegionInfo, UpdatePursuits, AssignClosestOffsets')
