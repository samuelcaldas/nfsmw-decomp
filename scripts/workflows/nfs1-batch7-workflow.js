export const meta = {
  name: 'nfsmw-parallel-decomp-batch7',
  description: 'Batch 7 decompilation: InitAtSegment, GetLoadingPriority, UpdateParticles, __InitMatrices',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: InitAtSegment (zWorld2) & GetLoadingPriority (zTrack)' },
    { title: 'Decomp-2', detail: 'Pair 2: UpdateParticles (zEcstasy) & __InitMatrices (zEcstasy)' },
...
log('Starting Batch 7: InitAtSegment, GetLoadingPriority, UpdateParticles, __InitMatrices')
