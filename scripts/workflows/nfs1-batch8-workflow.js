export const meta = {
  name: 'nfsmw-parallel-decomp-batch8',
  description: 'Batch 8 decompilation: RenderVisibleSectionBoundary, DetermineStreamingSections, InternalLoadStreamingEntry, CookieTrailCurvature',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: RenderVisibleSectionBoundary (zTrack) & DetermineStreamingSections (zTrack)' },
    { title: 'Decomp-2', detail: 'Pair 2: InternalLoadStreamingEntry (zEcstasy) & CookieTrailCurvature (zWorld2)' },
...
log('Starting Batch 8: RenderVisibleSectionBoundary, DetermineStreamingSections, InternalLoadStreamingEntry, CookieTrailCurvature')
