export const meta = {
  name: 'nfsmw-parallel-decomp-batch9',
  description: 'Batch 9 decompilation: UpdateOccludedPosition, BuildHoleMovements, EmitterSystem::Render, InternalLoadingHeaderPhase2Callback',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: UpdateOccludedPosition (zWorld2) & BuildHoleMovements (zTrack)' },
    { title: 'Decomp-2', detail: 'Pair 2: EmitterSystem::Render (zEcstasy) & InternalLoadingHeaderPhase2Callback (zEcstasy)' },
...
log('Starting Batch 9: UpdateOccludedPosition, BuildHoleMovements, EmitterSystem::Render, InternalLoadingHeaderPhase2Callback')
