export const meta = {
  name: 'nfsmw-parallel-decomp-batch14-nfs3',
  description: 'Batch 14 decompilation for nfs3: SuspensionTraffic::Tire::UpdateLoaded (zPhysicsBehaviors), MemcardCallbacks::CardChecked (zFe), cFEng::PushErrorPackage (zFe), CARSFX_RoadNoise::Play (zEAXSound2)',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: SuspensionTraffic::Tire::UpdateLoaded (zPhysicsBehaviors) & MemcardCallbacks::CardChecked (zFe)' },
    { title: 'Decomp-2', detail: 'Pair 2: cFEng::PushErrorPackage (zFe) & CARSFX_RoadNoise::Play (zEAXSound2)' },
...
const CANDIDATES_PAIR1 = [
  {
    ...
    extra_instructions: 'In SuspensionTraffic.cpp around line 273: inspect diff using python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zPhysicsBehaviors -d UpdateLoaded__Q217SuspensionTraffic4Tireffff. Notice r30 is preserved across the VU0_Atan2 call and used to hold the constant address (0.001f / lbl_803FB6B8), saving r30/r31 on stack (0x30 bytes stack frame instead of 0x28). Align local variable definitions, constant reuse in r30, and branch structures to reach 100.0% match parity with 0 regressions in ninja changes.',
  },
  {
    demangled: 'MemcardCallbacks::CardChecked',
    symbol: 'CardChecked__16MemcardCallbacksPCQ211RealmcIface8CardInfo',
    unit: 'main/Speed/Indep/SourceLists/zFe',
    size: 668,
    match: 95.5,
    source_file: 'src/Speed/Indep/Src/Frontend/MemoryCard/MemoryCardCallbacks.cpp',
    virtual_address: '0x8013A5C4',
    extra_instructions: 'In MemoryCardCallbacks.cpp around line 408: inspect diff using python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zFe -d CardChecked__16MemcardCallbacksPCQ211RealmcIface8CardInfo. In JLog(info), align Joylog::AddOrGetData field calls to match original field offset sequence (0x0, 0x4, 0x8, 0xc, 0x10, 0x14). Also align switch/case comparisons on info->mStatus. Aim for 100.0% match parity with 0 regressions in ninja changes.',
  },
]

const CANDIDATES_PAIR2 = [
  {
    demangled: 'cFEng::PushErrorPackage',
    symbol: 'PushErrorPackage__5cFEngPCciUl',
    unit: 'main/Speed/Indep/SourceLists/zFe',
    size: 332,
    match: 96.9,
    source_file: 'src/Speed/Indep/Src/Frontend/FEngInterfaces/FEngInterface.cpp',
    virtual_address: '0x80133910',
    extra_instructions: 'In FEngInterface.cpp around line 39: inspect diff using python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zFe -d PushErrorPackage__5cFEngPCciUl. Match register allocations for FEManager::mPauseRequest address in r11 and boolean flags (r0 vs r10). Eliminate branch offset and register differences to reach 100.0% match with 0 regressions.',
  },
  {
    demangled: 'CARSFX_RoadNoise::Play',
    ...
    extra_instructions: 'In CARSFX_Roadnoise.cpp around line 451: inspect diff using python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zEAXSound2 -d Play__16CARSFX_RoadNoise16FXROADNOISE_LOOPi. In new Csis::FX_ROADNOISE(...), align the constructor arguments and field initialization order to match the binary store sequence. Aim for 100.0% match with 0 regressions.',
  },
]
...
log('Starting Batch 14 for nfs3: SuspensionTraffic::Tire::UpdateLoaded, MemcardCallbacks::CardChecked, cFEng::PushErrorPackage, CARSFX_RoadNoise::Play')
...
if (mergedFunctions.length > 0) {
  ...
  await agent(
    ...
    '   git commit -m "docs: record Batch 14 decompiled functions in ledger and documentation\n\nCo-Authored-By: Claude Code <noreply@anthropic.com>"',
    {
      phase: 'Docs',
      label: 'docs:update',
    }
