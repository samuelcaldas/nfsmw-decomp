export const meta = {
  ...
  description: 'Batch 5 decompilation: PhysicsObject accessors (zPhysics), SuspensionSimple::Tire::UpdateLoaded (zPhysicsBehaviors), cFEng::FindPackage (zFe), GinsuSynthData::BindToData (zEAXSound2)',
  phases: [
    { title: 'Decomp-1', detail: 'Pair 1: PhysicsObject accessors (zPhysics) & cFEng::FindPackage (zFe)' },
...
const CANDIDATES_PAIR1 = [
  {
    demangled: 'PhysicsObject::GetPlayer',
    symbol: 'GetPlayer__C13PhysicsObject',
    unit: 'main/Speed/Indep/SourceLists/zPhysics',
    size: 48,
    match: 99.5,
    source_file: 'src/Speed/Indep/Src/Physics/Common/PhysicsObject.cpp',
    extra_instructions: 'In PhysicsObject.h, class PhysicsObject has member mWPos commented as offset 0x58, but compiled at 0x54 due to base class sizing. Adding a 4-byte pad (e.g. char _pad_base[4];) before mWPos shifts mWPos to 0x58, mObjType to 0x5C, mPlayer to 0x84, and mEntity to 0x80, bringing all 6 accessor methods (GetEntity, GetPlayer, GetSimableType, GetAttributes, GetOwnerHandle, GetRigidBody) to 100.0% matching. Verify with python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zPhysics -d GetPlayer__C13PhysicsObject and ninja.',
  },
  {
    demangled: 'cFEng::FindPackage',
    symbol: 'FindPackage__5cFEngPCc',
    unit: 'main/Speed/Indep/SourceLists/zFe',
    size: 156,
    match: 91.79,
    source_file: 'src/Speed/Indep/Src/Frontend/FEngInterfaces/FEngInterface.cpp',
    extra_instructions: 'In FEngInterface.cpp cFEng::FindPackage: simplify early checks and ensure return FindPackageIdle(pPackageName); returns directly or matches register r3 return flow as shown in python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zFe -d FindPackage__5cFEngPCc. Verify with ninja and decomp-diff.',
  },
]
...
const CANDIDATES_PAIR2 = [
  {
    ...
    extra_instructions: 'In SuspensionSimple.cpp, refine SuspensionSimple::Tire::UpdateLoaded. Inspect diff with python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zPhysicsBehaviors -d UpdateLoaded__Q216SuspensionSimple4Tireffffff. Tune minor local variable register allocations and condition branches. Ensure clean ninja build and 0 regressions.',
  },
  {
    ...
    extra_instructions: 'In ginsudata.cpp GinsuSynthData::BindToData: use register int i asm("r5") = 0 for loop counter and ensure mCurrentBlock = -1 stores -1 into offset 0xac using r0. Inspect python3 tools/decomp-diff.py -u main/Speed/Indep/SourceLists/zEAXSound2 -d BindToData__14GinsuSynthDataPv. Aim for 100% or highest parity.',
  },
]
...
log('Starting Batch 5: PhysicsObject accessors, cFEng::FindPackage, SuspensionSimple::Tire::UpdateLoaded, GinsuSynthData::BindToData')
